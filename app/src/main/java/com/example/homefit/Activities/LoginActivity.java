...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void createAccount(final String email, final String password) { //account creation
    ...
    private void firebaseAuthWithGoogle(GoogleSignInAccount acct) { //login with google user
    ...
    private boolean validateForm() { //email and password validation
        boolean valid = true;
